...
namespace UnitTesting.Parsers
{
    public class ParsersStreamSequencer : ITest
    {
        ...
        {
            var bs = new StreamSequencer("HTTP/1.1 404 Not found\r\nSuperHeader::master value\r\nSuperHeader!master value\r\nSuperHeader:-:master value\r\nHeader1: data1\r\nCookie: theme=light; sessionToken=abc123\r\nHeaderMultiple: x 1\r\nHeaderMultiple: x 2\r\nHeaderMultiple: x 3\r\nHeader2: data2\r\nHeader3: data3\r\nHeader4: data4\r\n\r\n      Hello! This is the body!");
            ...
            if(IsVerbose)
            {
                ...
                var cookies = StreamSequencer.Parse(
                    "[<cookies:$>][|name|:=][value:;|$][</>]",
        ...
        {
            ParserResult root = new StreamSequencer("HTTP/1.1 404 Not found\r\nHeader1: data1\r\nErrorHeader\r\nHeader2: data2\r\nHeader3: data3\r\nHeader4: data4\r\nErrorHeaderFinal\r\n\r\nHello! This is the body!")
                .Until("version", " ")
        ...
        {
            ParserResult root = StreamSequencer.Parse(
